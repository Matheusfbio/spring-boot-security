...
import br.com.br.com.spring_security.dto.Login;
import br.com.br.com.spring_security.dto.Session;
...
public class LoginController {
    ...
    public Session logar(@RequestBody Login login){
        ...
        if(user!=null) {
            ...
            jwtObject.setExpiration(new Date(System.currentTimeMillis() + Long.parseLong(SecurityConfig.EXPIRATION)));
